namespace QualityControl.Migrations
{
    ...
    public partial class Detectionscheme : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            AddColumn("dbo.GxDetectionScheme", "ProductId", c => c.Long(nullable: false));
            AddColumn("dbo.GxDetectionScheme", "CheckNum", c => c.String());
            AddColumn("dbo.GxContract", "ProductId", c => c.Long(nullable: false));
            AddColumn("dbo.GxContract", "CheckNum", c => c.String());
            AddColumn("dbo.GxContractModification", "DetectionSchemeId", c => c.Long(nullable: false));
